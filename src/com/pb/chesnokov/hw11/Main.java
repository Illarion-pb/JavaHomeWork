...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        persons.add(new Person("Чесноков Илларион Александрович", LocalDate.of(1983, 3, 13), "Потемкинская, 20"));
        persons.add(new Person("Иванов Иван Иванович", LocalDate.of(1987, 8, 27), "Ивановская, 22"));
        persons.add(new Person("Петров Петр Петрович", LocalDate.of(1988, 5, 22), "Петровская, 43"));
